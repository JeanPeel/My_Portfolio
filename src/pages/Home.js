                    ...
                    <div className="media_div1">
                        <div className='profile_group'>
                            ...
                            <div className='profile_div'>
                                ...
                                <p className='profile_text'>  <h6>Prow scuttle parrel  <a href="#" className="link"> Sail ho shrouds </a>spirits boom mizzenmast yardarm. Pinnace holystone mizzenmast quarter crow's nest nipperkin grog yardarm hempen halter furl. Swab barque interloper chantey doubloon starboard grog black jack gangway rutters.</h6>
